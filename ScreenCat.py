...
def toggle_eyes():
    ...
    new_color = 'SkyBlue1' if current_color == 'white' else 'white'
...
def show_happy(event):
    if(20 <= event.x <= 350) and (35 <= event.y <= 365):
...
win=Tk()
win.title("Screen Cat")
c=Canvas(win,height=400,width=400,bg="Dark blue")

circle=c.create_oval(35,20,365,350,outline="SkyBlue1",fill="SkyBlue1")
